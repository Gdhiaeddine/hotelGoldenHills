...
const FooterPages = ({ subtitle, title, imageSrc, ButtonDestination, buttonContent }: { subtitle?: string, title: string, imageSrc?: string, ButtonDestination?: string, buttonContent?: string }) => {
