...
const BookingInformation = () => {
    return (
        <div id='contactInformation' className='h-[70vh] flex justify-center items-center'>
            <div className='w-3/6 border p-8'>
                ...
                <div className='bg-gray-100 p-4'>
                    <div className="subHeader mb-4 flex justify-between items-center max-w-6/7 mx-auto">
