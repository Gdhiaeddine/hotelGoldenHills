    ...
    return (
        <div>
            ...
            <div className='min-h-screen'>
                ...
                <div className='min-h-screen flex items-center justify-center max-w-11/12 xl:max-w-3/5 mx-auto'>
                    <div className="relative h-[80vh] w-full">
                        <Image src='/assets/spa/jacuzzi.JPG' alt="Jacuzzi" fill className="object-cover object-center" />
                    </div>
                </div>

                <div className="w-full xl:max-w-3/5 flex flex-col xl:flex-row justify-between items-center gap-12 px-12 pt-16 pb-4 mx-auto">
                    ...
                    <div className="flex-1 flex justify-center items-center text-center xl:w-1/2">
                        <p className="text-md font-medium xl:max-w-2/3 mx-auto tracking-wider leading-relaxed text-justify">
                ...
                <div className='flex justify-center'>
                    <HeaderContent subtitle='SPA' title='Enter the sauna world in our Wellness & Spa' />
                </div>
                <div className='min-h-screen flex items-center justify-center max-w-11/12 xl:max-w-3/5 mx-auto'>
                    <div className="relative h-[80vh] w-full">
                ...
                <div className="w-full xl:max-w-3/5 flex-col xl:flex-row flex justify-between items-center gap-12 px-12 pt-16 pb-4 mx-auto">
                    <div className="flex-1 flex justify-center items-center text-center xl:w-1/2">
                        <p className="text-md font-medium xl:max-w-2/3 mx-auto tracking-wider leading-relaxed text-justify">
                ...
                <div className='flex justify-center'>
                    <HeaderContent subtitle='Hammam Turk' title='Traditional Turkish Hammam Experience' />
                </div>
