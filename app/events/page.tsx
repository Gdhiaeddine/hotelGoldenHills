...
const page = () => {
    ...
    return (
        <div>
            <HeroSection title={title} description={description} HeroSectionImage={HeroSectionImage} type={type} />
            <div className='min-h-[80vh] flex justify-center items-center'>
                <HeaderContent title={headerContentTitle} isLong={true} />
            </div>
            ...
            <div className="w-full xl:max-w-3/5 flex flex-col lg:flex-row justify-between items-center gap-12 px-12 pt-16 pb-4 mx-auto">
                ...
                <div className="flex-1 flex justify-center items-center text-center lg:w-1/2">
                    <div className="py-7 ">
                        <p
                            className={`${raleway.className} text-md font-medium xl:max-w-2/3 mx-auto tracking-wider leading-relaxed text-justify`}
                        >
            ...
            <div className="w-full xl:max-w-3/5 flex flex-col lg:flex-row justify-between items-center gap-12 px-12 pt-16 pb-4 mx-auto">
                ...
                <div className="flex-1 flex justify-center items-center text-center lg:w-1/2">
                    <div className="py-7 ">
                        <p
                            className={`${raleway.className} text-md font-medium lg:max-w-2/3 mx-auto tracking-wider leading-relaxed text-justify`}
                        >
